...
<html lang="en">
	...
	<body>
		<?php /* Converted from aboutus.html */ ?>
		<!-- SIDEBAR -->
		<section id="sidebar">
			<a href="#" class="brand" title="Macoy's Straightening Salon">
		...
		<section id="content">
			...
			<nav>
				...
				<a href="#" class="nav-link logged-in-only">Cutomer</a>
				<form action="#">
				...
				<a href="profile.php" class="profile logged-in-only" title="profile">
                    ...
                    <div class="infoAboutMe">
                        ...
                        <div class="iconLink">
                            <i class="fa-solid fa-phone contact-icon">
                                <a href="#">+63 9081135611</a>
                            </i>
                            <i class="fa-solid fa-envelope contact-icon">
                                <a href="#">macoysalon@gmail.com</a>
                            </i>
                        </div>
                    </div>
                </section>
